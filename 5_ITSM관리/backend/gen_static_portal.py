...
<aside class="sidebar" id="sidebar">
  ...
  <div class="sidebar-foot">대한민국 공공기관 표준운영관리 · ITIL v4 기반</div>
</aside>
"""
...
.nav-link {
  ...
  padding: 9px 12px; border-radius: 12px; color: #475467; text-decoration: none; font-size: 14px; font-weight: 600;
}
.nav-link:hover { background: #f2f4f7; color: #101828; }
...
.dom .c { font-size: 22px; font-weight: 800; margin-top: 6px; }
...
.card-head a { color: var(--brand); font-size: 12px; font-weight: 700; text-decoration: none; }
.table-wrap { overflow: auto; }
table { width: 100%; border-collapse: collapse; font-size: 13px; }
th, td { padding: 10px 12px; text-align: left; border-bottom: 1px solid var(--line); white-space: nowrap; }
th { background: #f8fafc; color: var(--muted); font-size: 11px; }
.mono { font-family: ui-monospace, Consolas, monospace; font-weight: 700; color: var(--brand); }
...
.mini { border-radius: 12px; padding: 10px 12px; }
.mini span { display: block; font-size: 12px; }
.mini b { font-size: 18px; }
.mini.ok { background: #ecfdf5; color: #047857; }
.mini.bad { background: #fff1f2; color: #be123c; }
.wbs-grid { display: grid; gap: 12px; }
.bar { height: 8px; background: #eef2ff; border-radius: 999px; overflow: hidden; margin: 10px 0 6px; }
